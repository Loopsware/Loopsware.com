...
<div class="showcase-section grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-8 my-8">
  <div class="flex items-end w-full border-3 border-gray-200 rounded-2xl">
    <img
      ...
      src="/public/images/medizona_showcase_1.png"
      alt="app_banner"
    />
  </div>
  <div class="flex items-end w-full border-3 border-gray-200 rounded-2xl">
    <img
      class="w-full h-fit object-cover rounded-2xl"
      src="/public/images/medizona_showcase_2.png"
      alt="app_banner"
    />
  </div>
  <div class="flex items-end w-full border-3 border-gray-200 rounded-2xl">
    <img
      class="w-full h-fit object-cover rounded-2xl"
      src="/public/images/medizona_showcase_3.png"
      alt="app_banner"
    />
  </div>
  <div class="flex items-end w-full border-3 border-gray-200 rounded-2xl">
    <img
      class="w-full h-fit object-cover rounded-2xl"
      src="/public/images/medizona_showcase_4.png"
      alt="app_banner"
    />
  </div>
</div>
